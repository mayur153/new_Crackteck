...
class _EditLeadScreenState extends State<EditLeadScreen> {
  ...
  // Dummy "existing lead" data (static demo)
  @override
  void initState() {
    super.initState();

    // Prefill like "editing lead"
    nameCtrl.text = 'Rahul Sharma';
    companyCtrl.text = 'Crackteck Pvt Ltd';
    designationCtrl.text = 'Facility Manager';
    numberCtrl.text = '9876543210';
    emailCtrl.text = 'rahul.sharma@example.com';
    addressCtrl.text = 'Andheri East, Mumbai - 400069';
    budgetCtrl.text = '₹ 50,000 - ₹ 1,00,000';
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Lead updated (static demo)'),
                        ),
                      );
                    }
                  },
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          // 👇 makes disabled fields look intentionally disabled, but still clean
          filled: !enabled,
          fillColor: !enabled ? Colors.black.withOpacity(0.03) : null,
        ),
      ),
    );
  }
