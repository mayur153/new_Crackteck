...
class DeliveryTermsConditionScreen extends StatelessWidget {
  final int roleId;
  final String roleName;

  const DeliveryTermsConditionScreen({
    super.key,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              /// =========================
              /// 🔴 ADD PRIVACY POLICY CONTENT BELOW
              /// =========================

              // ⬇️ Paste your paragraphs like this

              Text(
                """TermsCondition for Cracktack
